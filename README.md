...
|:------------------------|:------------------------|:-----------------|
| **Actualiza conceptos y conocimientos necesarios para su desarrollo profesional y en especial para su proyecto en soluciones de software.** | - **Jorge Luis Diaz Fiestas (TB1):** <br> • Investigué y apliqué metodologías Lean UX Canvas.<br> • Desarrollé análisis competitivo con matrices de comparación.<br> • Creé user personas completas con journey maps y empathy mapping.<br><br> - **Jorge Luis Diaz Fiestas (TB2):** <br>• Aprendí e integré nuevas prácticas de desarrollo móvil en Flutter para optimizar navegación y manejo de estados.<br>• Apliqué conocimientos actualizados para integrar el backend con la aplicación móvil.<br>• Profundicé en Kotlin para mejorar la comunicación entre servicios y la arquitectura del proyecto.<br><br>**Jorge Luis Diaz Fiestas (TF):** <br>• Integré nuevas prácticas de desarrollo móvil en Flutter para optimizar navegación y manejo de estados.<br>• Integración el backend con la aplicación móvil mediante el despliegue.<br>• <br><br>- **Ramirez Tello, Sebastian (TB1):** <br> • Apliqué técnicas de design thinking para discovery.<br> • Desarrollé entrevistas cualitativas y análisis de resultados.<br> • Implementé specification requirements con user stories.<br><br>- **Ramirez Tello, Sebastian (TB2):** <br>• Actualicé conocimientos en diseño UI/UX para crear prototipos funcionales en Figma para el Sprint 2.<br>• Aprendí nuevos widgets y estructuras avanzadas de Flutter para implementar interfaces del proyecto.<br>• Apliqué buenas prácticas de diseño centrado en el usuario para mejorar la usabilidad de las vistas. <br><br> **Ramirez Tello, Sebastian (TF):** • Adquirí nuevos conocimientos sobre widgets y estructuras avanzadas de Flutter para construir las interfaces del proyecto.<br>• Implementé buenas prácticas de diseño orientado al usuario para optimizar la usabilidad de las pantallas. <br><br>- **Julca Cruz, Renso Anthony (TB1):** <br> • Realicé dos entrevistas: una a una estudiante universitaria y otra a una persona autodidacta, recopilando experiencias sobre métodos de aprendizaje, retos y estrategias.<br> • Apliqué actividades de Strategic-Level Domain-Driven Design (DDD): EventStorming, Candidate Context Discovery, Domain Message Flows Modeling, Bounded Context Canvases. <br><br>-**Julca Cruz, Renso Anthony (TB2):** <br>• Actualicé y reestructuré todo el documento, mejorando la coherencia técnica y la redacción del Sprint 2.<br>• Apliqué nuevas técnicas de documentación ágil y reporting profesional.<br>• Aprendí métodos modernos para la elaboración y mejora continua de documentación técnica en proyectos de software. <br><br>- **Julca Cruz, Renso Anthony (TF):** <br>• Realicé una revisión integral y reestructuración del reporte del Sprint 3, elevando su precisión técnica y claridad expositiva.<br>• Adquirí competencias en metodologías modernas para la gestión eficiente y la mejora continua de la documentación en proyectos de software. <br><br>- **Gonzalez Custodio, Carlos Alberto (TB1)** <br> • Realice 2 entrevistas para el segmento Docente, para poder conocer más las necesidades de los usuarios. <br> • Presente los diagramas C4 que permite comprender de manera más clara como se organiza la solución.  Dichos diagramas son: Context Level Diagram, Container Level Diagram y Deployment <br><br>- **Gonzalez Custodio, Carlos Alberto (TB2):** <br>• Implementé nuevas funcionalidades en el backend y amplié mis conocimientos en Kotlin.<br>• Apliqué buenas prácticas de arquitectura para mejorar la interacción entre servicios y la app móvil.<br>• Aprendí nuevas estrategias para diseñar controladores, endpoints y lógica de negocio en el proyecto. <br><br>- **Gonzalez Custodio, Carlos Alberto (TF):** <br>• Implementé patrones de arquitectura robustos para optimizar la interoperabilidad y el flujo de datos entre los servicios y la aplicación móvil.<br>• Desarrollé e integré nuevos módulos en el backend, profundizando simultáneamente mi dominio técnico en el lenguaje Kotlin. | - **Jorge Luis Diaz Fiestas (TB1):** Actualicé mis conocimientos en metodologías ágiles y de diseño, aplicando con éxito Lean UX y DDD al proyecto. Mi investigación en análisis competitivo permitió identificar ventajas diferenciales para la solución.<br><br>- **Jorge Luis Diaz Fiestas (TB2):** <br>• Consolidé nuevos conocimientos en desarrollo móvil y backend, aplicándolos directamente en la implementación del Sprint 2.<br>• El aprendizaje en Flutter y Kotlin permitió mejorar la calidad técnica del producto y avanzar de manera eficiente en las funcionalidades desarrolladas.<br><br>- **Jorge Luis Diaz Fiestas (TF):** <br>• Lideré el despliegue exitoso de la aplicación móvil y consolidé competencias en backend, aplicándolas directamente en la implementación del sprint 3.<br>• El dominio técnico adquirido en Flutter y Kotlin permitió elevar los estándares de calidad del producto y asegurar una entrega eficiente de las funcionalidades.<br><br>- **Ramirez Tello, Sebastian (TB1):** Actualicé mis conocimientos en técnicas de discovery y engineering de requisitos, aplicando metodologías de design thinking y especificación ágil para el proyecto.<br><br>- **Ramirez Tello, Sebastian (TB2):** <br>• Apliqué conocimientos nuevos en diseño y desarrollo móvil, fortaleciendo la capacidad del equipo para entregar interfaces funcionales y centradas en la experiencia del usuario.<br>• Se evidenció crecimiento técnico al adoptar herramientas y conceptos avanzados en Figma y Flutter.<br><br>- **Ramirez Tello, Sebastian (TF):** <br>• La integración de competencias en diseño y desarrollo móvil potenció la capacidad del equipo para desplegar interfaces funcionales y orientadas a la experiencia de usuario.<br>• Se consolidó una evolución técnica significativa mediante la adopción de metodologías y herramientas avanzadas en Figma y Flutter.<br><br>- **Julca Cruz, Renso Anthony (TB1):** La aplicación de los conocimientos adquiridos en el curso, junto con la información de entrevistas, permitió actualizar y reforzar habilidades en el diseño de soluciones de software basadas en DDD. Esto evidencia la capacidad del grupo para adquirir nuevos conocimientos y adaptarlos al contexto del proyecto.  <br><br>- **Julca Cruz, Renso Anthony (TB2):** <br>• La actualización del documento reforzó mis habilidades en redacción técnica y documentación profesional, aplicando estándares más avanzados de claridad y organización.<br>• El proceso evidenció la importancia de mejorar continuamente las prácticas de documentación para soportar el desarrollo del proyecto.<br><br>- **Julca Cruz, Renso Anthony (TF):** <br>• La optimización integral del reporte consolidó mis competencias en redacción técnica, implementando estándares superiores de estructura y claridad profesional.<br>• Esta experiencia ratificó la necesidad de evolucionar constantemente las prácticas documentales como pilar fundamental para el soporte del desarrollo.<br><br>- **Gonzalez Custodio, Carlos Alberto (TB1):** Logré adquirir nuevas habilidades y conocimientos al comprender como elaborar Diagramas C4 ademas de poder entender las necesidades del usuario mediantes las entrevistas realizadas.<br><br>- **Gonzalez Custodio, Carlos Alberto (TB2):** <br>• La implementación del backend y el uso avanzado de Kotlin permitieron adquirir habilidades nuevas esenciales para el avance del proyecto.<br>• El aprendizaje aplicado fortaleció la arquitectura del sistema y la calidad de las funcionalidades desarrolladas.<br><br>- **Gonzalez Custodio, Carlos Alberto (TF):** <br>• La ejecución del desarrollo backend y el dominio de Kotlin permitieron adquirir destrezas fundamentales para impulsar el progreso del proyecto.<br>• Este aprendizaje técnico aplicado optimizó la arquitectura del sistema y elevó el estándar de calidad de las funcionalidades implementadas. |
| **Reconoce la necesidad del aprendizaje permanente para el desempeño profesional y el desarrollo de proyectos en soluciones de software.** | - **Jorge Luis Diaz Fiestas (TB1):** <br> • Aprendí técnicas avanzadas de needfinding.<br> • Investigué arquitecturas software escalables.<br> • Apliqué strategic modeling techniques.<br> • Desarrollé habilidades en competitive analysis. <br><br>-**Jorge Luis Diaz Fiestas (TB2):** <br>• Fortalecí mi comprensión sobre buenas prácticas de integración entre Flutter y backend.<br>• Investigué estrategias modernas para mejorar la comunicación entre servicios.<br>• Reconocí la importancia de seguir aprendiendo arquitectura y patrones de diseño para desarrollo móvil.<br><br>-**Jorge Luis Diaz Fiestas (TF):** <br>• Analicé estrategias modernas para optimizar la comunicación e interoperabilidad entre los servicios.<br>• Consolidé el dominio de buenas prácticas para lograr una integración robusta entre Flutter y el backend<br><br>- **Ramirez Tello, Sebastian (TB1):** <br> • Investigué best practices para startup profiling.<br> • Aprendí técnicas de problem framing y solution positioning.<br> • Desarrollé habilidades en qualitative research. <br><br> **Ramirez Tello, Sebastian (TB2):** <br>• Reforcé la importancia de actualizar técnicas de diseño UI/UX para mantener la calidad del producto.<br>• Investigué patrones modernos de experiencia de usuario para mejorar la app.<br>• Reconocí que el aprendizaje continuo es clave para el desarrollo móvil profesional.<br><br> **Ramirez Tello, Sebastian (TF):** <br>• Exploré patrones modernos de experiencia de usuario con el objetivo de optimizar la usabilidad de la aplicación.<br>• Asimilé el aprendizaje continuo como un pilar fundamental para alcanzar la excelencia en el desarrollo móvil profesional.<br><br>- **Julca Cruz, Renso Anthony (TB1):** <br> • Durante el desarrollo de las actividades de EventStorming y modelado de flujos de mensajes de dominio, se identificó la importancia de comprender de manera continua los cambios en los requerimientos del negocio y en las prácticas modernas de desarrollo de software. <br> • En las entrevistas se resaltó la relevancia de la autoformación y la actualización constante como factores clave para el crecimiento profesional. <br><br> **Julca Cruz, Renso Anthony (TB2):** <br>• Identifiqué la importancia de mantener al día las prácticas de documentación técnica y metodologías ágiles.<br>• Reforcé habilidades de redacción profesional y organización de información técnica.<br>• Comprendí que la mejora constante es esencial para producir documentación alineada a estándares profesionales.<br><br> **Julca Cruz, Renso Anthony (TB2):** <br>• Validé la relevancia de mantener actualizadas las prácticas de documentación técnica y las metodologías ágiles dentro del flujo de trabajo.<br>• Consolidé mis competencias en redacción profesional y en la estructuración eficiente de la información técnica.<br><br>- **González Custodio, Carlos Alberto (TB1):** <br> • Aprendí Software Architecture y creacion de modelos C4 para un mayor comprensión y entendimiento de como esta organizado todo siguiendo las buenas practicas.<br><br>-  **Gonzalez Custodio, Carlos Alberto (TB2):** <br>• Aprendí nuevas prácticas de arquitectura backend y manipulación de servicios en Kotlin.<br>• Reconocí la importancia del aprendizaje continuo para mantener sistemas escalables y robustos.<br>• Incorporé nuevos conocimientos para optimizar el backend y mejorar su calidad general.<br><br>-  **Gonzalez Custodio, Carlos Alberto (TF):** <br>• Apliqué estos conocimientos técnicos para optimizar el backend y potenciar su calidad global.<br>• Comprendí que la formación continua es vital para preservar la robustez y escalabilidad de los sistemas. | - **Jorge Luis Diaz Fiestas (TB1):** Demostré comprensión de que el aprendizaje continuo es esencial, investigando constantemente nuevas metodologías para mejorar la calidad del proyecto y su desarrollo profesional.<br><br>- **Jorge Luis Diaz Fiestas (TB2):** <br>• El Sprint 2 reafirmó que el aprendizaje continuo es esencial para adaptar el desarrollo móvil y backend a las necesidades del proyecto.<br>• Investigar nuevas técnicas permitió mejorar el rendimiento y la escalabilidad de la aplicación.<br><br>- **Jorge Luis Diaz Fiestas (TF):** <br>• La ejecución del Sprint 3 ratificó que la actualización constante es crucial para alinear el desarrollo móvil y backend con los requerimientos del proyecto.<br>• La investigación de técnicas emergentes fue determinante para potenciar el rendimiento y asegurar la escalabilidad de la aplicación..<br><br>- **Ramirez Tello, Sebastian (TB1):** Mostré reconocimiento de la necesidad de aprendizaje continuo, investigando constantemente nuevos approaches para validación de negocio y desarrollo de soluciones software efectivas. <br><br>- **Ramirez Tello, Sebastian (TB2):** <br>• Reafirmé la importancia de mantener actualizadas las prácticas de diseño y desarrollo móvil para mejorar usabilidad y eficiencia.<br>• El aprendizaje permanente es clave para sostener la calidad del diseño UI/UX en productos reales.<br><br>- **Ramirez Tello, Sebastian (TF):** <br>• Ratifiqué la relevancia de actualizar constantemente las prácticas de diseño y desarrollo móvil para optimizar la usabilidad y la eficiencia operativa.<br>• Confirmé que la formación continua es un factor determinante para garantizar la excelencia del diseño UI/UX en productos desplegados en entornos reales.<br><br>- **Julca Cruz, Renso Anthony (TB1):** El grupo reconoce que el aprendizaje no concluye con el curso, sino que debe mantenerse activo en la investigación y práctica de nuevas metodologías de diseño y arquitectura. Esto refuerza la visión de aprendizaje permanente como parte esencial del desempeño profesional en ingeniería de software. <br><br> **Julca Cruz, Renso Anthony (TB2):** <br>• La mejora constante en documentación técnica evidencia la necesidad de seguir aprendiendo y actualizando metodologías de ingeniería de software.<br>• La experiencia refuerza que la documentación profesional es un proceso iterativo que requiere actualización continua.<br><br> **Julca Cruz, Renso Anthony (TF):** <br>• La evolución constante de la documentación técnica pone de manifiesto la necesidad de actualizarse permanentemente en metodologías de ingeniería de software.<br>• Esta experiencia confirmó que la documentación profesional es un proceso dinámico e iterativo que exige un mantenimiento y refinamiento continuos.<br><br> **Gonzalez Custodio, Carlos Alberto (TB2):** <br>• La integración de nuevas técnicas de desarrollo backend reforzó la importancia del aprendizaje continuo para asegurar sistemas robustos.<br>• El reconocimiento de nuevas prácticas y herramientas permitió mejorar la calidad técnica del backend y su escalabilidad.<br><br> **González Custodio, Carlos Alberto (TB1):** Logré adquirir nuevos conocimientos y experiencia que me servirán para futuros trabajos y además para la conclusión del presente proyecto.<br><br> **González Custodio, Carlos Alberto (TF):** La implementación de técnicas modernas en el desarrollo backend confirmó que el aprendizaje continuo es un pilar esencial para construir sistemas robustos.<br>• La asimilación de nuevas herramientas y estándares permitió potenciar la calidad técnica de la infraestructura y garantizar su escalabilidad a largo plazo. |
...
| **Juan Carlos Orosco Ttamiña** <br><br> **Código:** U202414840 <br><br> **Carrera:** Ingeniería de Software <br><br> **Rol:** Miembro | Soy un estudiante de la carrera de Ingeniería de Software. Me interesa el ámbito tecnológico y la manera en que la innovación puede contribuir a optimizar las actividades de la vida diaria. Busco continuar fortaleciendo mis habilidades en distintos lenguajes de programación para desarrollarme de forma más sólida en el entorno profesional.| ![Foto Juan](assets/images/team/juan_orosco.jpeg) |
...
| **Hour** | 10:30 a. m. |
| **Location** | Virtual |
| **Prepared By** | Jorge Luis Diaz Fiestas |
| **Attendees (to planning meeting)** | Jorge Luis Diaz Fiestas, Carlos Alberto González Custodio, Renso Anthony Julca Cruz, Sebastian Ramirez Tello |
...
| **Entrevistado(a)**      | Jhosep Jamil Argomedo Camacho |
| **Edad**              | 19 años |
| **Rubro**             | Estudiante |
| **Ubicación**         | San Isidro |
| **Medio**             | Google Meet |
| **Entrevistador**     | Jhosep Jamil Argomedo Camacho |
| **Instante inicio**   | 00:00:05 |
